...
case "$os_test" in
  "centos7")
    tmt_plan="centos7"
    context="$context_prefixCentOS7$context_suffix"
    dockerfile="Dockerfile"
    compose="CentOS-7"
    ;;
  "c9s")
    tmt_plan="c9s"
    context="$context_prefixCentOS Stream 9"
    compose="CentOS-Stream-9"
    ;;
  "c8s")
    tmt_plan="c8s"
    context="$context_prefixCentOS Stream 8"
  ...
  "rhel7")
    ...
    context="$context_prefixRHEL7$context_suffix"
    compose="RHEL-7-LatestUpdated"
    ;;
  "rhel8")
    tmt_plan="rhel8$tmt_plan_suffix"
    context="$context_prefixRHEL8$context_suffix"
    compose="RHEL-8.8.0-Nightly"
    ;;
  "rhel9")
    tmt_plan="rhel9$tmt_plan_suffix"
    context="$context_prefixRHEL9$context_suffix"
  ...
  "rhel9-unsubscribed")
    ...
    context="$context_prefixRHEL9 - Unsubscribed host"
    compose="RHEL-9.2.0-Nightly"
    ;;
  ""|*)
    echo "::error::os_test '$os_test' is not valid"
